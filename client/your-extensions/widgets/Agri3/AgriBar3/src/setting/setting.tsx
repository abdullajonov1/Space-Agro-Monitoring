  ...
  render() {
    ...
    return (
      <div className="p-2">
        ...
        {/* Data source selector: [0] = polygon layer (ndvi, viloyat, yil), [1] = thresholds table (viloyat, past, orta, yaxshi, Yil) */}
        <div className="mb-3">
          <Label>Маълумот манбаини танланг (1–Полигон қатлам, 2–Пороглар жадвали):</Label>
          <DataSourceSelector
            mustUseDataSource
          ...
          <div className="mt-1" style={{ fontSize: 12, color: '#666' }}>
            Бирінчи манба — полигонлар (ndvi, viloyat, yil). Иккинчи — вилоят бўйича пороглар (past, orta, yaxshi, Yil).
          </div>
        </div>
